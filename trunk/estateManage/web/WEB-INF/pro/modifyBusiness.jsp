...
<html>
	<head>
		...
		<script type="text/javascript" src="<%=basePath%>scripts/pro/modifyBusiness.js"></script>
	...
	<body onunload="GUnload()">
		<div style="width: 100%; margin-top: 10px;" align="center">
			<table width="100%" class="layoutTab">
				<tr>
					<td valign="top">
									<form name="form" method="post" target="tempF"
			                    ...
			                    <div class="info_mid">					
										<table width="710px;" id="modifymessage" border="0" cellpadding="1" cellspacing="1">
											...
											<tr>
												...
												<td colspan="3">
													<input type="text" style="width:200px" readonly="readonly" value="${business.disname }" id="districtShow"/>
											...
											<tr>
												...
												<td colspan="3">
														<input type="text" name="business.address" id="address"maxlength="50"
															 readonly="readonly" value="${business.address}" size="50">
												</td>
											</tr>
											...
											<tr>
												...
												<td>
														<input type="text" size="10" name="business.area" value="${business.area==0.0?'':business.area}"maxlength="5"
															 readonly="readonly" id="area" onKeyUp="isNum(this)">
														㎡
												</td>
												<td align="right" >
												...
												<td >
														<input type="text" size="10" name="business.price" value="${business.price==0.0?'':business.price}"maxlength="5"
															 readonly="readonly" id="price" onKeyUp="isNum(this)">
														万元
												</td>
											</tr>
											<tr>
												...
												<td>
														<input type="text" name="business.propertyRent" value="${business.propertyRent==0.0?'':business.propertyRent}" 
															 readonly="readonly" id="propertyRent" size="10" id="propertyRent" onKeyUp="isNum(this)" />
															元/月
												</td>
											</tr>
											<tr>
												...
												<td>
														<estateTag:convertCode code="${business.payWay}"   codeType="租赁支付方式" />
												</td>
											</tr>	
											<tr>	
												<td align="right">
												...
												<td colspan="3"> 
														<input type="text" name="business.rentState" readonly="readonly"  value="${business.rentState}" id="rentState" size="20" maxlength="20"/>
												</td>
											</tr>
											<tr>
											...
											<tr>
												...
												<td> 
														<input type="text" name="business.capital" value="${business.capital==0.0?'':business.capital}" size="8" maxlength="5"
															id="capital" readonly="readonly"  onKeyUp="isNum(this)">
														万元
												...
												<td>
														<input type="text" onKeyUp="isNum(this)" value="${business.shares==0.0?'':business.shares}" maxlength="5"
															name="business.shares" id="shares" readonly="readonly"  size="8">
														%
												</td>
											</tr>
											<tr>
												...
												<td >
														<input type="text" size="30" id="scope"  readonly="readonly"  name="business.scope"maxlength="50" value="${business.scope}">
												</td>
												<td align="right">
														已经营年限:
												</td>
												<td>
														<input type="text" name="business.businessYear"
															 readonly="readonly" onKeyUp="this.value=this.value.replace(/\D/g,'')" maxlength="4" value="${business.businessYear==0?'':business.businessYear}"
											...
											<tr>
												...
												<td>
														<input
																name="business.businessturnover" id="businessturnover"maxlength="4" type="text" value="${business.businessturnover==0.0?'':business.businessturnover}"
																 readonly="readonly" onKeyUp="isNum(this)" size="8">万元
												</td>
												<td  align="right">
														过去一年利润:
												</td>
												<td>
														 <input	type="text" size="8" id="businessprofits" name="business.businessprofits"maxlength="4"
																 readonly="readonly" onKeyUp="isNum(this)" value="${business.businessprofits==0.0?'':business.businessprofits}">万元
												</td>
											...
											<tr>
												...
												<td>
													<input type="text" onKeyUp="isNum(this)"
																 readonly="readonly" name="business.incomeTax" id="incomeTax" size="8" maxlength="4" value="${business.incomeTax==0.0?'':business.incomeTax}">万元
												</td>
											...
											<tr>
												...
												<td>
														<input type="text" name="business.employees" readonly="readonly"  maxlength="4" onKeyUp="this.value=this.value.replace(/\D/g,'')" value="${business.employees==0?'':business.employees}" size="8">人
												</td>
											</tr>
											...
											<tr>
												...
												<td  align="left" colspan="3" >
													<input id="rid" type="hidden" name="business.id" value="${business.id }"/>
													<input id="authorId" type="hidden" name="business.authorId" value="${business.authorId }"/>
													<estateTag:select cssStyle="width:120px" id="auditingState" value="${business.auditingState }" name="business.auditingState" codeType="审核状态" headerKey="" headerValue="请选择" />
												</td>
											</tr>
											<tr>
												<td align="right">
												...
												<td id="filter_ke" align="left" colspan="3" >
														<textarea cols="60" rows="10" name="business.auditingRemark" id="auditingRemark">${business.auditingRemark}</textarea>
												</td>
											</tr>
											<tr>
												<td colspan="4" align="center">
