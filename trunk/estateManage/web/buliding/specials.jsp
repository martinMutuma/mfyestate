	...
	<table border="0" width="100%" height="100%" cellpadding="0" cellspacing="0" style="overflow: hidden;">
		<tr>
			...
			<form action="../special/saveSpecial.shtml" method="post">
				...
				<input type="hidden" name="special.flag" value="1"/>
				<table border="0" width="99%">
					...
					<tr>
						<td valign="top" align="right">市场参考均价：</td><td valign="top"><input onkeydown="onlyNum()" maxlength="5" name="special.avgPrice" value="<s:property value="special.avgPrice"/>" style="width: 150px;"/></td>
					</tr>
					<tr>
						<td valign="top" align="right">折后参考起价：</td><td valign="top"><input onkeydown="onlyNum()" maxlength="5" name="special.minPrice" value="<s:property value="special.minPrice"/>" style="width: 150px;"/></td>
					</tr>
					<tr>
