...
public class IndustryServiceImpl implements IndustryService {
	...
	public List<Industry> getList(Map<String, String> map, String start,
		...
		if (map == null || map.size() == 0)
			return null;
		try {
			String sql = "select * from t_p_industry  where   Flag="
					+ map.get("type");
			...
			if (!"-1".equals(map.get("autingSate")))
			 ...
			 if(!"-1".equals(map.get("area1"))) sql+=" and   constructionArea  between  "+map.get("area1") +"  and  "+map.get("area2");
			 if( !"".equals(map.get("price1") ) && !"-1".equals(map.get("price1"))) sql+=" and  bursary between  "+Integer.parseInt(map.get("price1"))*365 +"  and  "+Integer.parseInt(map.get("price2"))*365;
	...
	public Industry getById(String id, String type) {
	 ...
	 public   boolean  delPic(String id,String urlname){
	    	...
	    	String  sql="update  t_p_industry  set  "+urlname+"=null ,"+"imgName"+lastStr+"=null , imgType"+lastStr +"=null  where  id=?";
	    	try {
