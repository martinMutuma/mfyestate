...
*地区列表
*/
var disAry = new Array('3201000000,南京市','3207000000,连云港市','3208000000,淮安市','3209000000,盐城市')
function headLoad(){
...
function onAttion(id,attentionNum){
  	var url = "building/attentionOff.shtml?id="+id+"&attentioncount="+attentionNum+"&time="+(new Date().getTime().toString(36));
