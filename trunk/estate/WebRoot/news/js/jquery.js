...
$.ajaxSetup({dataType:"json", type:"POST", beforeSend:function (xhr) {
	xhr.setRequestHeader("isAjax", "true");
}});
jQuery.extend({postJson:function (url, data, success, error) {
...
Pn.checkLen = function (o, len) {
	len = len || 1;
	if (o.val() == undefined || $.trim(o.val()) == "" || $.trim(o.val()).length < len) {
		return false;
	} else {
		return true;
	}
...
$.validator.AlertError = {invalidHandler:function (form, validator) {
...
jQuery.extend(jQuery.validator.messages, {required:"\u6b64\u9879\u4e3a\u5fc5\u586b\u9879", remote:"\u8bf7\u4fee\u6b63\u8be5\u9879", email:"\u8bf7\u8f93\u5165\u6b63\u786e\u683c\u5f0f\u7684\u7535\u5b50\u90ae\u4ef6", url:"\u8bf7\u8f93\u5165\u5408\u6cd5\u7684\u7f51\u5740", date:"\u8bf7\u8f93\u5165\u5408\u6cd5\u7684\u65e5\u671f", dateISO:"\u8bf7\u8f93\u5165\u5408\u6cd5\u7684\u65e5\u671f", number:"\u8bf7\u8f93\u5165\u5408\u6cd5\u7684\u6570\u5b57", digits:"\u53ea\u80fd\u8f93\u5165\u6574\u6570", creditcard:"\u8bf7\u8f93\u5165\u5408\u6cd5\u7684\u4fe1\u7528\u5361\u53f7", equalTo:"\u4e24\u6b21\u8f93\u5165\u4e0d\u4e00\u81f4\uff0c\u8bf7\u91cd\u65b0\u8f93\u5165", accept:"\u8bf7\u8f93\u5165\u62e5\u6709\u5408\u6cd5\u540e\u7f00\u540d\u7684\u5b57\u7b26\u4e32", maxlength:jQuery.format("\u8bf7\u8f93\u5165\u4e00\u4e2a\u957f\u5ea6\u6700\u591a\u662f {0}; \u7684\u5b57\u7b26\u4e32"), minlength:jQuery.format("\u8bf7\u8f93\u5165\u4e00\u4e2a\u957f\u5ea6\u6700\u5c11\u662f {0}; \u7684\u5b57\u7b26\u4e32"), rangelength:jQuery.format("\u8bf7\u8f93\u5165\u4e00\u4e2a\u957f\u5ea6\u4ecb\u4e8e {0}; \u548c {1}; \u4e4b\u95f4\u7684\u5b57\u7b26\u4e32"), range:jQuery.format("\u8bf7\u8f93\u5165\u4e00\u4e2a\u4ecb\u4e8e {0}; \u548c {1}; \u4e4b\u95f4\u7684\u503c"), max:jQuery.format("\u8bf7\u8f93\u5165\u4e00\u4e2a\u6700\u5927\u4e3a {0}; \u7684\u503c"), min:jQuery.format("\u8bf7\u8f93\u5165\u4e00\u4e2a\u6700\u5c0f\u4e3a {0}; \u7684\u503c")});
...
JCore.UpRoller = function (rid, speed, isSleep, sleepTime, rollCount, rollSpan, unitHight) {
	this.speed = speed;
	this.rid = rid;
...
JCore.UpRoller.prototype.roll = function () {
	if (this.proll[0].scrollTop > this.prollCopy[0].offsetHeight) {
		...
		if (this.proll[0].scrollTop % (this.unitHight * this.rollCount) == 0 && this.sleepCount <= this.sleepTime && this.isSleep) {
			this.sleepCount++;
			...
			var modCount = (this.proll[0].scrollTop + this.rollSpan) % (this.unitHight * this.rollCount);
...
JCore.checkUserName = function (username, base) {
	base = base || "";
	$.postJson(base + "/jeecms/core/ajax/checkUserName.do", {"username":username}, function (data) {
		if (data.success) {
...
Auxi.saveMsg = function (base, callback) {
	base = base || "";
	$.postJson(base + "/jeecms/ajax/auxiliary/msgSave.do", {"ctg.id":$("#msg_ctg_id").val(), "title":$("#msg_title").val(), "content":$("#msg_content").val(), "checkCode":$("#msg_checkCode").val()}, function (data) {
		if (callback) {
