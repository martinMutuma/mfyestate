    ...
    <div class="house_x_dt">
                ...
                <div class="house_nav">
                    <div id="house_nav">
                        ...
                        <a href="housetype.shtml?pid=<s:property value='tpBulding.id'/>&page=0"     class="nav_housOn" >户型</a> 
                	...
                	<div class="pic_se" id="seehcon1" > <!--全部图片-->
                        <ul>
                          <s:iterator value="selectedUnitList">
                            <li>
                                <span class="hosee_pic"><a href="showimage.shtml?pid=<s:property value='tpBulding.id'/>&type=9&imgid=<s:property value='id'/>" target="_blank" title="<s:property value='imgName'/>"><img src="<s:property value='imgName'/>" title="../<s:property value='imgUrl'/>" alt="<s:property value='imgName'/>"/></a></span>
...
<dl class="apply" id="tuan1">
    ...
    <div class="join_buy">
            ...
            <form id="showingsForm" name="showingsForm" action="showings.shtml" method="post" class="j_form" target="tempF">
                ...
                <div class="div">
                    <div class="left"><label>电子邮箱：</label><input id="temail" type="text" class="j_butt" /><br /><span id="joinTuanTips_email" style="color:red; font-weight:bold;"></span><span id="submitBt"><input id="joinTuanBt" name="" type="submit" class="j_bu" onclick="joinTuan($('#tname').val(),$('#ttel').val(),$('#temail').val())" value =""/></span></div>
