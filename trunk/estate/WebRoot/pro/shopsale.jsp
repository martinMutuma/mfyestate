...
<html>
  <head>
    ...
    <script type="text/javascript" src="shopsale.js"></script>
	...
	<jsp:include page="../head.jsp"></jsp:include>
     	<div style="width: 100%; margin-top: 10px;" align="center">
			...
			<tr>
				...
				<td valign="top"  >
                            <div class="position" align="left" style="width:80%"><label>您所在的位置：</label><a href="../home.shtml">梦房园</a>&nbsp;&nbsp;&gt;&nbsp;&nbsp;<a href="../mem/baseinfo_mainPage.shtml">会员中心</a>&nbsp;&nbsp;&gt;&nbsp;&nbsp;<a href="manageshopsale.jsp?menuCls=12">商铺出售管理</a>&nbsp;&nbsp;&gt;&nbsp;&nbsp;<a href="shopsale.jsp?menuCls=14">发布商铺出售信息</a></div>
									...
									<form name="form" method="post" action="../shop/addShop.shtml"
										...
										<table width="710px;" border="0" cellpadding="1" cellspacing="1" id="shopsale">
											...
											<tr>
												...
												<%-- onKeyUp="this.value=this.value.replace(/^[0-9\u4e00-\u9faf]+$/,'')"--%>
														<input class="easyui-validatebox" required="true" missingMessage="商铺名称必填" type="text" name="shop.name"
															id="name" style="width: 300px" value="${shop.name }" maxlength="20">
												</td>
											</tr>
											<tr>
												<td align="right">
												...
												<td align="left">
													<input name="shop.address" id="address" maxlength="80" style="width: 300px" value="${shop.address }"  class="easyui-validatebox" required="true" missingMessage="商铺地址必填"/>
												</td>
											</tr>
											<tr>
												<td align="right">
											...
											<tr>
												...
												<td align="left">
													<input id="area"
														name="shop.area" maxlength="8" style="width: 60px" onKeyUp="isNum(this)" value="${shop.area }"  class="easyui-validatebox" required="true" missingMessage="建筑面积必填"/> ㎡
												</td>
											</tr>
											<tr>
												<td align="right">
												...
												<td align="left">
													<input id="areauseful"
														name="shop.areauseful" maxlength="8" style="width: 60px" onKeyUp="isNum(this)" value="${shop.areauseful }"  class="easyui-validatebox" required="true" missingMessage="使用面积必填"/> ㎡
												</td>
											</tr>
											<tr>
												<td align="right">
												...
												<td align="left">
														<input type="text" maxlength="5" name="shop.bursary" id="bursary"
															onKeyUp="isNum(this)" id="bursary" style="width: 60px" class="easyui-validatebox" required="true" missingMessage="售价必填">
														万元
												</td>
											</tr>
											<tr>
											...
											<tr>
												...
												<td align="left">
														<input maxlength="40" name="shop.title" value="${shop.title}" id="title" type="text"
											...
											<tr>
												...
												<td>
													<div align="left">
														<input type="text" name="shop.imgName1" id="imgName1" maxlength="25"/>
														&nbsp; &nbsp; &nbsp;
														<estateTag:select cssStyle="width:80px" value="1" name="shop.imgType1" id="imgType1" codeType="新房图片类型" />
														&nbsp; &nbsp; &nbsp;
											...
											<tr>
												...
												<td>
													<div align="left">
														<input type="text" name="shop.imgName2" id="imgName2" maxlength="25"/>
														&nbsp; &nbsp; &nbsp;
														<estateTag:select cssStyle="width:80px" value="2" name="shop.imgType2" id="imgType2" codeType="新房图片类型" />
														&nbsp; &nbsp; &nbsp;
											...
											<tr>
												...
												<td>
													<div align="left">
														<input type="text" name="shop.imgName3" id="imgName3" maxlength="25"/>
														&nbsp; &nbsp; &nbsp;
														<estateTag:select cssStyle="width:80px" value="3" name="shop.imgType3" id="imgType3" codeType="新房图片类型" />
														&nbsp; &nbsp; &nbsp;
											...
											<tr>
												...
												<td>
													<div align="left">
														<input type="text" name="shop.imgName4" id="imgName4" maxlength="25"/>
														&nbsp; &nbsp; &nbsp;
														<estateTag:select cssStyle="width:80px" value="4" name="shop.imgType4" id="imgType4" codeType="新房图片类型" />
														&nbsp; &nbsp; &nbsp;
											...
											<tr>
												...
												<td>
													<div align="left">
														<input type="text" name="shop.imgName5" id="imgName5" maxlength="25"/>
														&nbsp; &nbsp; &nbsp;
														<estateTag:select cssStyle="width:80px" value="5" name="shop.imgType5" id="imgType5" codeType="新房图片类型" />
														&nbsp; &nbsp; &nbsp;
											...
											<tr>
												<td colspan="2" align="center">
													...
													<!-- 2表示 出售 -->
													<input type="hidden" name="shop.flag" value="2" />
