...
<html>
  <head>
    ...
    <title>修改生意转让图片信息</title>
		...
		<script type="text/javascript" src="bsaddpic.js"></script>
		...
		<script type="text/javascript">
		     ...
		     function  goback(){
		           window.location.href="<%=basePath%>business/getPic.shtml?id=${bs.id}";
		     }
		</script>   
	</head>
	  ...
	  <jsp:include page="../head.jsp"></jsp:include>
		...
		<table width="100%" class="layoutTab">
			<tr>
				...
				<td valign="top">
				   <form name="form" method="post" action="../business/modifAddPic.shtml"	 enctype="multipart/form-data" onsubmit="return checkAddImg()">
					  ...
					  <table  cellpadding="1"  border="0"  cellspacing="1" width="90%" >
					   <tr align="center"><td>序号</td><td>图片名称</td><td>图片类型</td><td>上传图片</td></tr>
					   	<tr>
												...
												<td><input type="text" name="business.imgName1" id="imgName1" /></td>
												<td>
													<div  align="left">
													  &nbsp; &nbsp; &nbsp;
														<select name="business.imgType1">
											...
											<tr>
												...
												<td>	<input type="text" name="business.imgName2" id="imgName2" /></td>
												<td>
													<div align="left">
													
														&nbsp; &nbsp; &nbsp;
														<select name="business.imgType2">
															<option value="1">
																室内图
															</option>
											...
											<tr>
												<td colspan="4" align="center">
													...
													<input type="hidden"  name="business.id" value="${bs.id}"/>
