...
<html>
  <head>
    ...
    <title>修改商品图片信息</title>
		...
		<script type="text/javascript" src="shopaddpic.js"></script>
		...
		<script type="text/javascript">
		     ...
		     function  goback(){
		        window.location.href="<%=basePath%>shop/getPic.shtml?id=${sp.id}&type=${sp.flag}";
	...
	=<jsp:include page="../head.jsp"></jsp:include>
		...
		<table width="100%" class="layoutTab">
			<tr>
				...
				<td valign="top">
				   <form name="form" method="post" action="../shop/modifAddPic.shtml"	 enctype="multipart/form-data" onsubmit="return checkAddImg()">
					<div class="position" align="left" style="width:80%"><label>您所在的位置：</label><a href="../home.shtml">梦房园</a>&nbsp;&nbsp;&gt;&nbsp;&nbsp;<a href="../mem/baseinfo_mainPage.shtml">会员中心</a>&nbsp;&nbsp;&gt;&nbsp;&nbsp;商铺案源管理&nbsp;&nbsp;&gt;&nbsp;&nbsp;图片修改</div>
					  ...
					  <table  cellpadding="1"  border="0"  cellspacing="1" width="90%" >
					   <tr align="center"><td>序号</td><td>图片名称</td><td>图片类型</td><td>上传图片</td></tr>
					   	<tr>
												...
												<td><input type="text" name="shop.imgName1" id="imgName1" /></td>
												<td>
													<div  align="left">
													  &nbsp; &nbsp; &nbsp;
														<select name="shop.imgType1">
											...
											<tr>
												...
												<td>	<input type="text" name="shop.imgName2" id="imgName2" /></td>
												<td>
													<div align="left">
													
														&nbsp; &nbsp; &nbsp;
														<select name="shop.imgType2">
															<option value="1">
																室内图
															</option>
											...
											<tr>
												...
												<td>
												   <input type="text" name="shop.imgName3" id="imgName3" />
												</td>
												<td>
													<div align="left">
														
														&nbsp; &nbsp; &nbsp;
														<select name="shop.imgType3">
															<option value="1">
																室内图
															</option>
															<option value="2">
											...
											<tr>
												...
												<td>
												  <input type="text" name="shop.imgName4" id="imgName4" />
												</td>
												<td>
													<div align="left">
													
														&nbsp; &nbsp; &nbsp;
														<select name="shop.imgType4">
															<option value="1">
																室内图
															</option>
															<option value="2">
											...
											<tr>
												...
												<td>
												  	<input type="text" name="shop.imgName5" id="imgName5" />
												</td>
												<td>
													<div align="left">
													
														&nbsp; &nbsp; &nbsp;
														<select name="shop.imgType5">
															<option value="1">
																室内图
															</option>
															<option value="2">
											...
											<tr>
												<td colspan="4" align="center">
													...
													<input type="hidden"  name="shop.id" value="${sp.id}"/>
													<input type="hidden"  name="shop.flag" value="${sp.flag}"/>
												</td>
											</tr>
				</table>
					</div>
