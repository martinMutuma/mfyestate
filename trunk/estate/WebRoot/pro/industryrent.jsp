...
<html>
  <head>
	...
	<script type="text/javascript" src="industryrent.js"></script>
				...
				<td valign="top">
					<table border="0" cellpadding="0" id="industryrentTab" cellspacing="0">
						<tr>
							...
							<div class="position" align="left" style="width:80%"><label>您所在的位置：</label><a href="../home.shtml">梦房园</a>&nbsp;&nbsp;&gt;&nbsp;&nbsp;<a href="../mem/baseinfo_mainPage.shtml">会员中心</a>&nbsp;&nbsp;&gt;&nbsp;&nbsp;<a href="manageindustryrent.jsp?menuCls=14">工业地产出租管理</a>&nbsp;&nbsp;&gt;&nbsp;&nbsp;<a href="industryrent.jsp">发布工业地产出租信息</a></div>
												...
												<form name="form" method="post"
													...
													<table width="710px" border="0" id="buildingrent" cellpadding="1"
														...
														<tr>
															...
															<td align="left">
																	<input type="text"  maxLength="5" id="area" name="industry.area"
														...
														<tr>
															...
															<td align="left">
																	<input id="spaceArea" maxLength="5" type="text" name="industry.spaceArea"
																		onkeyup="isNum(this)" size="10">
																	㎡
															</td>
														</tr>
														...
														<tr>
															...
															<td align="left">
																	<input type="text" id="greenRate" maxLength="5" size="10" onkeyup="isNum(this)"
														...
														<tr>
															...
															<td align="left">
																	<input type="text" maxLength="9" id="bear" name="industry.bear" size="30" />
															</td>
														</tr>
														<tr>
															<td align="right">
														...
														<tr>
															...
															<td align="left">
																<input type="text" id="water" maxLength="3"  onkeyup="isNum(this)"
