 ...
 */
 $(function(){
 	$("#modifyshopdemand td").not($("#filter_ke td")).addClass("info_td1");
	$("#modifyshopdemand tr").find("td:even").not($("#filter_ke td")).addClass("title_info2");
	$("#modifyshopdemand tr").find("td:odd").not($("#filter_ke td")).css("padding-left","5px");
