...
<html>
  <head>
    ...
    <title>修改写字楼图片信息</title>
		<meta http-equiv="pragma" content="no-cache">
		<meta http-equiv="cache-control" content="no-cache">
		<meta http-equiv="expires" content="0">
		<meta http-equiv="keywords" content="梦房园">
		<meta http-equiv="description" content="修改写字楼上传的图片信息。">
		...
		<script type="text/javascript" src="../resource/js/global.js"></script>
			<script type="text/javascript" src="addpic.js"></script>
	...
	<body>
		...
		<table width="100%" class="layoutTab">
			<tr>
				...
				<td valign="top">
				  <form name="form" method="post" 	action="../office/modifAddPic.shtml" enctype="multipart/form-data" onsubmit="return checkAddImg()">
					  ...
					  <table  cellpadding="1"  border="0"  cellspacing="1" width="90%" >
					   <tr align="center"><td>序号</td><td>图片名称</td><td>图片类型</td><td>上传图片</td></tr>
					   	<tr>
												...
												<td><input type="text" name="office.imgName1" id="imgName1" /></td>
												<td>
													<div  align="left">
													  &nbsp; &nbsp; &nbsp;
														<select name="office.imgType1">
											...
											<tr>
												...
												<td>	<input type="text" name="office.imgName2" id="imgName2" /></td>
												<td>
													<div align="left">
													
														&nbsp; &nbsp; &nbsp;
														<select name="office.imgType2">
															<option value="1">
																室内图
															</option>
											...
											<tr>
												...
												<td>
												   <input type="text" name="office.imgName3" id="imgName3" />
												</td>
												<td>
													<div align="left">
														
														&nbsp; &nbsp; &nbsp;
														<select name="office.imgType3">
															<option value="1">
																室内图
															</option>
															<option value="2">
											...
											<tr>
												...
												<td>
												  <input type="text" name="office.imgName4" id="imgName4" />
												</td>
												<td>
													<div align="left">
													
														&nbsp; &nbsp; &nbsp;
														<select name="office.imgType4">
															<option value="1">
																室内图
															</option>
															<option value="2">
											...
											<tr>
												...
												<td>
												  	<input type="text" name="office.imgName5" id="imgName5" />
												</td>
												<td>
													<div align="left">
													
														&nbsp; &nbsp; &nbsp;
														<select name="office.imgType5">
															<option value="1">
																室内图
															</option>
															<option value="2">
											...
											<tr>
												<td colspan="4" align="center">
													...
													<input type="hidden"  name="office.id" value="${off.id}"/>
													<input type="hidden"  name="office.flag" value="${off.flag}"/>
												</td>
											</tr>
					</table>
					</div>
