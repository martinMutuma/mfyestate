...
<html>
							...
							<div class="info_left">
								<div class="info_left1">
									...
									<div class="specials1">
										...
										<div style="float:left;paddin-left:10px"><a href="javascript:onjointuan();"><span class="specials_can"></span></a></div>
								...
								梦房园专享折扣: ${special.specials }+梦房园会员优惠
   			...
   			<div class="whole_width h_split">
   				<div class="left_width">
					...
					<div class="left_width2 h_split" align="left">
						<h5 align="center">除了最低折扣，还有梦房园独家的优惠和无限的贴心服务！</h5>
						${special.information }
					</div>
   				</div>
  ...
  function show_time(){
	...
	function onjointuan(){
		...
		window.location.href="jointuan.shtml?id="+${special.id}+"&bid="+${special.bulidingId}+"&menuIndex=5";
	}
  </script>
