		...
		<tr>
			...
			<td valign="top" class="line">
				...
				<span id="rc_9_0_1" class="search_column"
					onclick="search('8','0','','YnVpbGRpbmdfdHlwZQ==',this,'0_1','9')"
					style="cursor: pointer">住宅</span>
				<span id="rc_9_0_2" class="search_column"
					onclick="search('8','1','','YnVpbGRpbmdfdHlwZQ==',this,'0_2','9')"
					style="cursor: pointer">公寓</span>
				<span id="rc_9_0_3" class="search_column"
					onclick="search('8','2','','YnVpbGRpbmdfdHlwZQ==',this,'0_3','9')"
					style="cursor: pointer">海景房</span>
				<span id="rc_9_0_4" class="search_column"
					onclick="search('8','3','','YnVpbGRpbmdfdHlwZQ==',this,'0_4','9')"
					style="cursor: pointer">别墅</span>
				<span id="rc_9_0_5" class="search_column"
					onclick="search('8','4','','YnVpbGRpbmdfdHlwZQ==',this,'0_5','9')"
					style="cursor: pointer">酒店式公寓</span>
				<span id="rc_9_0_6" class="search_column"
					onclick="search('8','5','','YnVpbGRpbmdfdHlwZQ==',this,'0_6','9')"
		...
		<tr>
			...
			<td valign="top" class="line">
				...
				<span id="rc_9_1_1" class="search_column"
					onclick="search('3','5000','','YXZlcmFnZV9wcmljZQ==',this,'1_1','9')"
					style="cursor: pointer">5000元以下/㎡</span>
				<span id="rc_9_1_2" class="search_column"
					onclick="search('7','5000','8000','YXZlcmFnZV9wcmljZQ==',this,'1_2','9')"
					style="cursor: pointer">5000-8000元/㎡</span>
				<span id="rc_9_1_3" class="search_column"
					onclick="search('7','8000','10000','YXZlcmFnZV9wcmljZQ==',this,'1_3','9')"
					style="cursor: pointer">8000-1万元/㎡</span>
				<span id="rc_9_1_4" class="search_column"
					onclick="search('7','10000','12000','YXZlcmFnZV9wcmljZQ==',this,'1_4','9')"
					style="cursor: pointer">1万-1.2万元/㎡</span>
				<span id="rc_9_1_5" class="search_column"
					onclick="search('7','12000','15000','YXZlcmFnZV9wcmljZQ==',this,'1_5','9')"
					style="cursor: pointer">1.2万-1.5万元/㎡</span>
				<span id="rc_9_1_6" class="search_column"
					onclick="search('7','15000','20000','YXZlcmFnZV9wcmljZQ==',this,'1_6','9')"
					style="cursor: pointer">1.5万-2万元/㎡</span>
				<span id="rc_9_1_7" class="search_column"
					onclick="search('4','20000','','YXZlcmFnZV9wcmljZQ==',this,'1_7','9')"
		...
		<tr>
			...
			<td valign="top" class="line">
				...
				<span id="rc_9_2_1" class="search_column"
					onclick="search('5','0','','c2FsZXNfc3RhdHVz',this,'2_1','9')"
					style="cursor: pointer">待售楼盘</span>
				<span id="rc_9_2_2" class="search_column"
					onclick="search('5','1','','c2FsZXNfc3RhdHVz',this,'2_2','9')"
					style="cursor: pointer">预售楼盘</span>
				<span id="rc_9_2_3" class="search_column"
					onclick="search('5','2','','c2FsZXNfc3RhdHVz',this,'2_3','9')"
					style="cursor: pointer">在售楼盘</span>
				<span id="rc_9_2_4" class="search_column"
					onclick="search('5','3','','c2FsZXNfc3RhdHVz',this,'2_4','9')"
					style="cursor: pointer">尾盘</span>
				<span id="rc_9_2_5" class="search_column"
					onclick="search('5','4','','c2FsZXNfc3RhdHVz',this,'2_5','9')"
					style="cursor: pointer">售完楼盘</span>
			</td>
		</tr>
		<tr>
			<td class="search_column_span line" valign="top">
		...
		<tr>
			...
			<td valign="top" class="line">
				...
				<span id="rc_9_4_1" class="search_column"
					onclick="search('8','1','','YXJjaF9mb3JtcyMx',this,'4_1','9')"
					style="cursor: pointer">多层</span>
				<span id="rc_9_4_2" class="search_column"
					onclick="search('8','2','','YXJjaF9mb3JtcyMx',this,'4_2','9')"
					style="cursor: pointer">高层</span>
				<span id="rc_9_4_3" class="search_column"
					onclick="search('8','3','','YXJjaF9mb3JtcyMx',this,'4_3','9')"
...
<div id="ts" align="left">
	...
	<span id="lpts"><a id="lpts_0" href="javascript:lptsSearch('')">不限</a><a
		...
		class="" id="lpts_9" href="javascript:lptsSearch('8')">水景地产</a>
	</span>
</div>
