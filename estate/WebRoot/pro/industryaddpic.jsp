  ...
  <head>
    ...
    <title>修改工业地产图片信息</title>
		...
		<script type="text/javascript" src="../resource/js/global.js"></script>
			<script type="text/javascript" src="industryaddpic.js"></script>
			<link rel="stylesheet" href="../resource/css/memberCenter/info.css" type="text/css"></link>
		<script type="text/javascript">
		 
		     function  goback(){
		            window.location.href="<%=basePath%>industry/getPic.shtml?id=${idu.id}&type=${idu.flag}";
		     }
		</script>   
	</head>

	<body>
	    &ldquo;<jsp:include page="../head.jsp"></jsp:include>
		<div style="width: 100%; margin-top: 10px;" align="center">
		<table width="100%" class="layoutTab">
			<tr>
				<td width="20%" align="left" valign="top">&ldquo;&rdquo;<jsp:include page="../left.jsp"></jsp:include></td>
				<td valign="top">
				 <form name="form" method="post" action="../industry/modifAddPic.shtml"	 enctype="multipart/form-data" onsubmit="return checkAddImg()">
					...
					<div style="margin-left: 40px;margin-bottom: 10px;margin-top: 10px;float:left" > 
								  工业地产案源名称：${idu.title}  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  案源编号:${idu.num}   
				    </div>
					  ...
					  <table  cellpadding="1"  border="0"  cellspacing="1" width="90%" >
					   <tr align="center"><td>序号</td><td>图片名称</td><td>图片类型</td><td>上传图片</td></tr>
					   	<tr>
												...
												<td><input type="text" name="industry.imgName1" id="imgName1" /></td>
												<td>
													<div  align="left">
													  &nbsp; &nbsp; &nbsp;
														<select name="industry.imgType1">
											...
											<tr>
												...
												<td>	<input type="text" name="industry.imgName2" id="imgName2" /></td>
												<td>
													<div align="left">
													
														&nbsp; &nbsp; &nbsp;
														<select name="industry.imgType2">
															<option value="1">
																室内图
															</option>
											...
											<tr>
												...
												<td>
												   <input type="text" name="industry.imgName3" id="imgName3" />
												</td>
												<td>
													<div align="left">
														
														&nbsp; &nbsp; &nbsp;
														<select name="industry.imgType3">
															<option value="1">
																室内图
															</option>
															<option value="2">
											...
											<tr>
												...
												<td>
												  <input type="text" name="industry.imgName4" id="imgName4" />
												</td>
												<td>
													<div align="left">
													
														&nbsp; &nbsp; &nbsp;
														<select name="industry.imgType4">
															<option value="1">
																室内图
															</option>
															<option value="2">
											...
											<tr>
												...
												<td>
												  	<input type="text" name="industry.imgName5" id="imgName5" />
												</td>
												<td>
													<div align="left">
													
														&nbsp; &nbsp; &nbsp;
														<select name="industry.imgType5">
															<option value="1">
																室内图
															</option>
															<option value="2">
											...
											<tr>
												<td colspan="4" align="center">
													...
													<input type="hidden"  name="industry.id" value="${idu.id}"/>
													<input type="hidden"  name="industry.flag" value="${idu.flag}"/>
												</td>
											</tr>
					</table>
					</div>
