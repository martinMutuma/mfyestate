...
<html>
  <head>
    ...
    <script type="text/javascript" src="shoprent.js"></script>
	...
	<jsp:include page="../head.jsp"></jsp:include>
     	<div style="width: 100%; margin-top: 10px;" align="center">
			...
			<tr>
				...
				<td valign="top"  >
                            <div class="position" align="left" style="width:80%"><label>您所在的位置：</label><a href="../home.shtml">梦房园</a>&nbsp;&nbsp;&gt;&nbsp;&nbsp;<a href="../mem/baseinfo_mainPage.shtml">会员中心</a>&nbsp;&nbsp;&gt;&nbsp;&nbsp;<a href="manageshoprent.jsp?menuCls=12">商铺出租管理</a>&nbsp;&nbsp;&gt;&nbsp;&nbsp;<a href="shopsale.jsp?menuCls=14">发布商铺出租信息</a></div>
					                  <div class="info_top"></div><div class="info_mid">	
									<form name="form" method="post" action="../shop/addShop.shtml"
										enctype="multipart/form-data"
										onsubmit="return checkshoprent();">
										<table width="710px;" border="0" cellpadding="1" cellspacing="1" id="shopsale">
											...
											<tr>
												...
												<td align="left">
														<input type="text" maxlength="10" name="shop.bursary" id="bursary"
											...
											<tr>
												<td colspan="2" align="center">
													...
													<!-- 1表示 出租 -->
													<input type="hidden" name="shop.flag" value="1" />
