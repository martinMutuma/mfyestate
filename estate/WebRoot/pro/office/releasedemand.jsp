											...
											<tr>
												...
												<td>
														<input type="text" name="need.address"
															value="${need.address}" id="address" maxLength="35"  size="35" />
														&nbsp;临近&nbsp;
														<input name="need.nearAddress" id="nearAddress" maxLength="35" value="${need.nearAddress}"
															type="text" size="35" />
												</td>
											</tr>
											<tr>
												...
												<td>
														<input type="text" size="8" name="need.minArea"
															id="minArea" maxLength="6" onKeyUp="isNum(this)" />
														&nbsp;-&nbsp;
														<input type="text" id="maxArea" maxLength="6" name="need.maxArea"
											...
											<tr>
												...
												<td>
														<input type="text" size="8" name="need.minPrice"
															id="minPrice" maxLength="6" onKeyUp="isNum(this)" />
														&nbsp;-&nbsp;
														<input type="text" name="need.maxPrice" id="maxPrice"
															onKeyUp="isNum(this)" maxLength="6" size="8" />
														万元/年
												</td>
											</tr>
											<tr>
												...
												<td>
														<input type="text" name="need.title" maxLength="40" id="title" size="40"
															value="${need.title}">
												</td>
											</tr>
											<tr>
