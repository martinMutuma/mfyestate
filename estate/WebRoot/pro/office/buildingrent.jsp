	 ...
	 <jsp:include page="../../head.jsp"></jsp:include>
		...
		<table width="100%" class="layoutTab">
			<tr>
				...
				<!-- 5.valign -->
				<td valign="top">
				<div class="position" align="left"><label>您所在的位置：</label><a href="../../home.shtml">梦房园</a>&nbsp;&nbsp;&gt;&nbsp;&nbsp;<a href="../../mem/baseinfo_mainPage.shtml">会员中心</a>&nbsp;&nbsp;&gt;&nbsp;&nbsp;<a href="managerent.jsp?menuCls=11">写字楼出租管理</a>&nbsp;&nbsp;&gt;&nbsp;&nbsp;<a href="buildingrent.jsp">发布写字楼出租信息</a></div>
											...
											<tr>
												...
												<%-- onKeyUp="this.value=this.value.replace(/^[0-9\u4e00-\u9faf]+$/,'')"--%>
														<input class="easyui-validatebox" required="true" missingMessage="楼盘名称必填" type="text" name="office.name"
															id="name" style="width: 200px" value="${office.name }" maxlength="30">
												</td>
											</tr>
											<tr>
												<td align="right">
												...
												<td align="left">
													<input maxlength="100" name="office.address" id="address" style="width: 300px" value="${office.address }"  class="easyui-validatebox" required="true" missingMessage="楼盘地址必填"/>
												</td>
											</tr>
											<tr>
												<td align="right">
