...
<html>
	<head>
		...
		<script type="text/javascript" src="officeSyn.js"></script>
	...
	<body>
		...
		<div style="width: 100%; height: 100%;" align="center">
			<table width="100%" class="layoutTab">
				...
				<tr>
					<td width="25%" align="left" valign="top"><jsp:include
			...
			<div id="win" title="My Window" >
			   ...
			   <tr>
			   	...
			   	<tr>
			   		<td align="center"><img title="www.house365.com" width="100%" src="../resource/images/integration/esf_logo.gif"/></td>
			   		<td align="center"><img id="imgLogin365" title="登陆365" src="../resource/images/integration/login_03.gif" onclick="login('365')"/></td>
