...
public class SpecialsServiceImpl implements SpecialsService {
	...
	public List<TpSpecials> findActiveSpecials(int count, String type) {
		String sql = "select * from t_p_specials where flag = '" + type
	...
	public List<SpecialsBean> findTop6Specials(String type) {
		...
		String sql = "select b.Id,b.DISNAME,b.name,b.MIN_PRICE,s.specials,s.createTime,b.compressUrl from t_p_specials s join t_p_building b where s.bulidingId = b.Id and s.flag = "
				+ type + " order by createTime desc  LIMIT 0,6 ";
