...
th {
	...
	<body>
		<form name="form1" action="menu_saveOrUpdate.shtml" method="post">
				...
				<tbody>
					...
					<tr>
						...
						<td class="forumrowhighlight"  width="60%" height="24" >
							<input name="menu.name"  value="<s:property value="menu.name"/>" />
						</td>
					</tr>
					<tr>
						...
						<td class="forumrowhighlight" height="24">
							<input maxlength="80" size="50" name="menu.url"
								value="<s:property value="menu.url"/>" />
						</td>
					</tr>
					<tr>
						<td class="forumrow" height="24" align='right'>
						...
						<td class="forumrowhighlight" height="24">
							<input maxlength="30" name="menu.tip" value="<s:property value="menu.tip"/>" />
						</td>
					</tr>
					<tr>
						<td class="forumrow" height="24" align='right'>
						...
						<td class="forumrowhighlight" height="24">
							<input maxlength="50" name="menu.descr" value="<s:property value="menu.descr"/>" />
						</td>
					</tr>
					<tr>
						<td class="forumrow" height="24" align='right'>
						...
						<td class="forumrowhighlight" height="24">
							<input maxlength="2" onkeyup="this.value=this.value.replace(/\D/g,'')"
								name="menu.orderNum" value="<s:property value="menu.orderNum"/>" />
						</td>
					</tr>
					<tr>
						<td class="forumrow" height="24" align='right'>
						...
						<td class="forumrowhighlight" height="24">
							<s:if test="flag==2">
								<s:if test="menu.mainMenu==0">
								  否
					       </s:if>
								<s:if test="menu.mainMenu==1">
								  是
								 </s:if>
							</s:if>
							<s:else>
								<s:radio list="#{'0':'否','1':'是'}" name="menu.mainMenu"
									theme="simple" />
							</s:else>
						</td>
					</tr>
