					...
					<table border="0" cellpadding="0" cellspacing="0" width="760px">
						<tr>
							<td valign="top" align="center" >
									<form name="form1" method="post"  target="tempF"
										...
										<table width="710px;" border="0" cellpadding="1" id="buildingrent" cellspacing="1">
											...
											<tr>
												...
												<%-- onKeyUp="this.value=this.value.replace(/^[0-9\u4e00-\u9faf]+$/,'')"--%>
														<input class="easyui-validatebox" required="true" missingMessage="楼盘名称必填" type="text" name="office.name"
															id="name" style="width: 200px" value="${office.name }" maxlength="25" readonly="readonly">
												</td>
											</tr>
											<tr>
												<td align="right">
												...
												<td align="left">
													<input name="office.address" id="address" readonly="readonly" style="width: 300px" value="${office.address }"  class="easyui-validatebox" required="true" missingMessage="楼盘地址必填"/>
												</td>
											</tr>
											<tr>
												<td align="right">
												...
												<td align="left">
													<input type="text" style="width:200px"  value="${office.disname }" readonly="readonly"/>
											...
											<tr>
												...
												<td align="left">
													<input id="area"
														readonly="readonly" name="office.area" maxlength="8" style="width: 60px" onKeyUp="isNum(this)" value="${office.area }"  class="easyui-validatebox" required="true" missingMessage="建筑面积必填"/> ㎡
												</td>
											</tr>
											<tr>
												<td align="right">
												...
												<td align="left">
													<input id="areauseful"
														readonly="readonly" name="office.areauseful" maxlength="8" style="width: 60px" onKeyUp="isNum(this)" value="${office.areauseful }"  class="easyui-validatebox" required="true" missingMessage="使用面积必填"/> ㎡
												</td>
											</tr>
											...
											<tr>
												...
												<td align="left">
													<estateTag:convertCode codeType="租赁方式" code="${office.rentType }"></estateTag:convertCode>
												</td>
											</tr>
											</c:if>
											...
											<tr>
												...
												<td align="left">
														<input type="text" maxlength="10" name="office.price"
															readonly="readonly" onKeyUp="isNum(this)" id="price" style="width: 60px" value="${office.price }" class="easyui-validatebox" required="true" missingMessage="租金单价必填">
														<c:if test='${office.flag eq "1"}'>元/㎡·天
														&nbsp;&nbsp;&nbsp;&nbsp;<estateTag:convertCode code="${office.payInfo}" codeType="租赁支付方式"></estateTag:convertCode>
														&nbsp;&nbsp;&nbsp;&nbsp;<estateTag:convertCode code="${office.officeCost}" codeType="是否"></estateTag:convertCode>
											...
											<tr>
												...
												<td align="left">
													<input id="propertyManagement"
														readonly="readonly" name="office.propertyManagement" maxlength="8" style="width: 60px" value="${office.propertyManagement}" class="easyui-validatebox" required="true" missingMessage="物业管理费必填"/> 元/㎡·月
												</td>
											</tr>
											<tr>
												<td align="right">
												...
												<td align="left">
														<estateTag:convertCode code="${office.floorType}" codeType="楼层类型" ></estateTag:convertCode>
												</td>
											</tr>
											<tr>
												<td align="right">
											...
											<tr>
												...
												<td align="left">
														<estateTag:convertCode code="${office.mright}" codeType="产权性质"></estateTag:convertCode>
												</td>
											</tr>
											<tr>
												<td align="right">
												...
												<td align="left">
														<estateTag:convertCode code="${office.fitment}" codeType="装修程度" />
												</td>
											</tr>
											<tr>
												<td align="right">
												...
												<td align="left">
													<estateTag:convertCode code="${office.forward}" codeType="朝向" ></estateTag:convertCode>
												</td>
											</tr>
											...
											<tr>
												...
												<td align="left">
													<input style="width: 120px;" value="${office.cbd }" readonly="readonly"  name="office.cbd" id="cbd" maxlength="10" class="easyui-validatebox" required="true" missingMessage="所属商圈必填"/>
												</td>
											</tr>
											</c:if>
											<tr>
											...
											<tr>
												...
												<td id="filter_ke" align="left">
														<textarea cols="60" rows="10" name="office.content" readonly="readonly" id="content">${office.content}</textarea>
												</td>
											</tr>
											<tr>
												<th align="left" colspan="2" class="title_info1" valign="bottom">
											...
											<tr>
												...
												<td>
													<div align="left">
														<estateTag:convertCode code="${office.category}" codeType="写字楼类别"></estateTag:convertCode>
													</div>
												</td>
											</tr>
											<tr>
												...
												<td align="left">
														<input name="office.consYear" value="${office.consYear}" id="consYear" type="text"
															readonly="readonly" style="width: 120px" onKeyUp="isNum(this)" maxlength="4">年
												</td>
											</tr>
											<tr>
												<td align="right">
												...
												<td align="left">
													<estateTag:convertCode codeType="配套设施" code="${office.baseService}"></estateTag:convertCode>
												</td>
											</tr>
											<tr>
												<td align="right">
												...
												<td align="left">
													<estateTag:convertCode codeType="房屋设备" code="${office.equipment}"></estateTag:convertCode>
												</td>
											</tr>
											<tr>
												<td align="right">
											...
											<tr>
												...
												<td  align="left">
													<input id="rid" type="hidden" name="office.id" value="${office.id }"/>
													<input id="authorId" type="hidden" name="office.authorId" value="${office.authorId }"/>
													<estateTag:select cssStyle="width:120px" id="auditingState" value="${office.auditingState }" name="office.auditingState" codeType="审核状态" headerKey="" headerValue="请选择" />
												</td>
											</tr>
											<tr>
												<td align="right">
												...
												<td id="filter_ke" align="left">
														<textarea cols="60" rows="10" name="office.auditingRemark" id="auditingRemark">${office.auditingRemark}</textarea>
												</td>
											</tr>
											<tr>
