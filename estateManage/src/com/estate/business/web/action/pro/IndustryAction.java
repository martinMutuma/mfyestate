...
import com.estate.business.service.pro.IndustryService;
import com.estate.business.service.pro.IndustryServiceImpl;
	...
	public String addIndustry() {
		...
		if ("".equals(id)) {
			...
			if (imageFile1 != null) {
				...
				String fileName = new Date().getTime() + imageFile1FileName;
				if (FileUtil.doUpFile(basePath + imagePatn + fileName,
						imageFile1)) {
					industry.setImgUrl1(fileName);
				}
			}
			if (imageFile2 != null) {
				...
				String fileName = new Date().getTime() + imageFile2FileName;
				if (FileUtil.doUpFile(basePath + imagePatn + fileName,
						imageFile2))
					industry.setImgUrl2(fileName);
			...
			if (imageFile3 != null) {
				...
				String fileName = new Date().getTime() + imageFile3FileName;
				if (FileUtil.doUpFile(basePath + imagePatn + fileName,
						imageFile3))
					industry.setImgUrl3(fileName);
			...
			if (imageFile4 != null) {
				...
				String fileName = new Date().getTime() + imageFile4FileName;
				if (FileUtil.doUpFile(basePath + imagePatn + fileName,
						imageFile4))
					industry.setImgUrl4(fileName);
			...
			if (imageFile5 != null) {
				...
				String fileName = new Date().getTime() + imageFile5FileName;
				if (FileUtil.doUpFile(basePath + imagePatn + fileName,
						imageFile5))
					industry.setImgUrl5(fileName);
		...
		industry.setCreateTime(new Date());
		if (service.addIndustry(industry))
			return "success";
		return "error";
	}
